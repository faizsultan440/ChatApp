...
import com.example.rbchat.databinding.ItemReceiveGroupBinding;
import com.example.rbchat.databinding.ItemRecieveBinding;
import com.example.rbchat.databinding.ItemSendBinding;
import com.example.rbchat.databinding.ItemSentGroupBinding;
                        ...
                        .addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                if(snapshot.exists())
                                {
                                    ...
                                    viewHolder.binding.name.setText(user.getuName());
                                }
                            }
                            @Override
